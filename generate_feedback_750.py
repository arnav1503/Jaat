...
def main():
    print("--- 🚀 GENERATING 750 FAKE FEEDBACKS ---", flush=True)
    client = get_client()
    sh = client.open_by_key(SPREADSHEET_ID)
    
    # Check/Create Feedback Sheet
    try:
        ...
        ws_feedback.resize(rows=TARGET_FEEDBACKS + 10) 
    ...
    for full_name in selected_names:
        ...
        part1 = random.randint(10, 20)  # Random number like 18
        part2 = random.randint(10, 99)  # Random number like 20
